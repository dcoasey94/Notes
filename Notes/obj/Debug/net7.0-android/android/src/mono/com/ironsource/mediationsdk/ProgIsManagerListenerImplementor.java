...
/** @hide */
	...
	static {
		__md_methods = 
			"n_onInterstitialAdClicked:(Lcom/ironsource/mediationsdk/ProgIsSmash;)V:GetOnInterstitialAdClicked_Lcom_ironsource_mediationsdk_ProgIsSmash_Handler:Com.Ironsource.Mediationsdk.IProgIsManagerListenerInvoker, IronSource-Android_v7.3.0.1\n" +
			"n_onInterstitialAdClosed:(Lcom/ironsource/mediationsdk/ProgIsSmash;)V:GetOnInterstitialAdClosed_Lcom_ironsource_mediationsdk_ProgIsSmash_Handler:Com.Ironsource.Mediationsdk.IProgIsManagerListenerInvoker, IronSource-Android_v7.3.0.1\n" +
			"n_onInterstitialAdLoadFailed:(Lcom/ironsource/mediationsdk/logger/IronSourceError;Lcom/ironsource/mediationsdk/ProgIsSmash;J)V:GetOnInterstitialAdLoadFailed_Lcom_ironsource_mediationsdk_logger_IronSourceError_Lcom_ironsource_mediationsdk_ProgIsSmash_JHandler:Com.Ironsource.Mediationsdk.IProgIsManagerListenerInvoker, IronSource-Android_v7.3.0.1\n" +
			"n_onInterstitialAdOpened:(Lcom/ironsource/mediationsdk/ProgIsSmash;)V:GetOnInterstitialAdOpened_Lcom_ironsource_mediationsdk_ProgIsSmash_Handler:Com.Ironsource.Mediationsdk.IProgIsManagerListenerInvoker, IronSource-Android_v7.3.0.1\n" +
			"n_onInterstitialAdReady:(Lcom/ironsource/mediationsdk/ProgIsSmash;J)V:GetOnInterstitialAdReady_Lcom_ironsource_mediationsdk_ProgIsSmash_JHandler:Com.Ironsource.Mediationsdk.IProgIsManagerListenerInvoker, IronSource-Android_v7.3.0.1\n" +
			...
			"n_onInterstitialAdShowSucceeded:(Lcom/ironsource/mediationsdk/ProgIsSmash;)V:GetOnInterstitialAdShowSucceeded_Lcom_ironsource_mediationsdk_ProgIsSmash_Handler:Com.Ironsource.Mediationsdk.IProgIsManagerListenerInvoker, IronSource-Android_v7.3.0.1\n" +
			"n_onInterstitialAdVisible:(Lcom/ironsource/mediationsdk/ProgIsSmash;)V:GetOnInterstitialAdVisible_Lcom_ironsource_mediationsdk_ProgIsSmash_Handler:Com.Ironsource.Mediationsdk.IProgIsManagerListenerInvoker, IronSource-Android_v7.3.0.1\n" +
			...
			"n_onInterstitialInitSuccess:(Lcom/ironsource/mediationsdk/ProgIsSmash;)V:GetOnInterstitialInitSuccess_Lcom_ironsource_mediationsdk_ProgIsSmash_Handler:Com.Ironsource.Mediationsdk.IProgIsManagerListenerInvoker, IronSource-Android_v7.3.0.1\n" +
			"";
		mono.android.Runtime.register ("Com.Ironsource.Mediationsdk.IProgIsManagerListenerImplementor, IronSource-Android_v7.3.0.1", ProgIsManagerListenerImplementor.class, __md_methods);
	}
	...
	public ProgIsManagerListenerImplementor ()
	{
		...
		if (getClass () == ProgIsManagerListenerImplementor.class) {
			mono.android.TypeManager.Activate ("Com.Ironsource.Mediationsdk.IProgIsManagerListenerImplementor, IronSource-Android_v7.3.0.1", "", this, new java.lang.Object[] {  });
		}
	}
