...
/** @hide */
	...
	static {
		__md_methods = 
			"n_onLoadError:(Lcom/ironsource/mediationsdk/ProgRvSmash;Ljava/lang/String;)V:GetOnLoadError_Lcom_ironsource_mediationsdk_ProgRvSmash_Ljava_lang_String_Handler:Com.Ironsource.Mediationsdk.IProgRvManagerListenerInvoker, IronSource-Android_v7.3.0.1\n" +
			"n_onLoadSuccess:(Lcom/ironsource/mediationsdk/ProgRvSmash;Ljava/lang/String;)V:GetOnLoadSuccess_Lcom_ironsource_mediationsdk_ProgRvSmash_Ljava_lang_String_Handler:Com.Ironsource.Mediationsdk.IProgRvManagerListenerInvoker, IronSource-Android_v7.3.0.1\n" +
			"n_onRewardedVideoAdClicked:(Lcom/ironsource/mediationsdk/ProgRvSmash;Lcom/ironsource/mediationsdk/model/Placement;)V:GetOnRewardedVideoAdClicked_Lcom_ironsource_mediationsdk_ProgRvSmash_Lcom_ironsource_mediationsdk_model_Placement_Handler:Com.Ironsource.Mediationsdk.IProgRvManagerListenerInvoker, IronSource-Android_v7.3.0.1\n" +
			"n_onRewardedVideoAdClosed:(Lcom/ironsource/mediationsdk/ProgRvSmash;)V:GetOnRewardedVideoAdClosed_Lcom_ironsource_mediationsdk_ProgRvSmash_Handler:Com.Ironsource.Mediationsdk.IProgRvManagerListenerInvoker, IronSource-Android_v7.3.0.1\n" +
			"n_onRewardedVideoAdEnded:(Lcom/ironsource/mediationsdk/ProgRvSmash;)V:GetOnRewardedVideoAdEnded_Lcom_ironsource_mediationsdk_ProgRvSmash_Handler:Com.Ironsource.Mediationsdk.IProgRvManagerListenerInvoker, IronSource-Android_v7.3.0.1\n" +
			"n_onRewardedVideoAdOpened:(Lcom/ironsource/mediationsdk/ProgRvSmash;)V:GetOnRewardedVideoAdOpened_Lcom_ironsource_mediationsdk_ProgRvSmash_Handler:Com.Ironsource.Mediationsdk.IProgRvManagerListenerInvoker, IronSource-Android_v7.3.0.1\n" +
			...
			"n_onRewardedVideoAdStarted:(Lcom/ironsource/mediationsdk/ProgRvSmash;)V:GetOnRewardedVideoAdStarted_Lcom_ironsource_mediationsdk_ProgRvSmash_Handler:Com.Ironsource.Mediationsdk.IProgRvManagerListenerInvoker, IronSource-Android_v7.3.0.1\n" +
			"";
		mono.android.Runtime.register ("Com.Ironsource.Mediationsdk.IProgRvManagerListenerImplementor, IronSource-Android_v7.3.0.1", ProgRvManagerListenerImplementor.class, __md_methods);
	}
	...
	public ProgRvManagerListenerImplementor ()
	{
		...
		if (getClass () == ProgRvManagerListenerImplementor.class) {
			mono.android.TypeManager.Activate ("Com.Ironsource.Mediationsdk.IProgRvManagerListenerImplementor, IronSource-Android_v7.3.0.1", "", this, new java.lang.Object[] {  });
		}
	}
